...
if($_POST['function'] == 'save'){
    ...
    $sql = "INSERT INTO `embarktion_tbl`(`applicantId`, `firstname`, `lastname`, `middlename`, `status`, `rank`, `vessel`, `type`, `grossTonage`, `dateEnrolled`, `port_fdids_1`, `duration`, `embarkedDate_sbds`, `disembarkedDate_sbds`,`remarks`) 
    ...
    '$vesselStatus','$rank','$vessel','$type','$gross','$dateEnrolled','$port',
